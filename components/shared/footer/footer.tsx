  ...
  return (
    <Container>
      <footer className="rounded-lg bg-foreground dark:bg-gray-900 text-background">
        <div className=" pt-12 pb-3 px-12 mx-auto">
            ...
            <div className="w-full -mx-6 lg:w-6/12">
              <div className="px-6">
                ...
                <p className="max-w-sm mt-2  ">
                  Anim est Lorem sunt incididunt nulla laboris nisi
                ...
                <div className="flex mt-3 -mx-2">
                  <a
                    href="#"
                    className="mx-2  transition-colors duration-300 dark:text-gray-300"
                    aria-label="Reddit"
                  >
                    <svg
